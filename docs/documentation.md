...
| `mailcli drafts create/list/inspect/preview/edit/update/handoff/open/save/send/reconcile/discard/prune` | Implemented | Manage plain/Markdown/safe-HTML drafts, visibly hand new drafts to Mail.app, inspect persisted drafts, send over SMTP, reconcile claims, discard, and prune stale drafts |
