...
MAILCLI_RELEASE_DIRECTORY="${RELEASE_DIRECTORY}" \
  "${MAILCLI_ROOT}/scripts/release/build-release.sh" 1.0.4

ARCHIVE="${RELEASE_DIRECTORY}/mailcli_1.0.4_darwin_arm64.tar.gz"
...
for REQUIRED_PATH in \
  mailcli_1.0.4_darwin_arm64/bin/mailcli \
  mailcli_1.0.4_darwin_arm64/skills/mailcli/SKILL.md \
  mailcli_1.0.4_darwin_arm64/skills/mailcli/agents/openai.yaml \
  mailcli_1.0.4_darwin_arm64/install.sh \
  mailcli_1.0.4_darwin_arm64/README.md \
  mailcli_1.0.4_darwin_arm64/LICENSE; do
...
PACKAGE_ROOT="${TEST_ROOT}/mailcli_1.0.4_darwin_arm64"
...
[[ "$("${INSTALLED_BINARY}" version)" == "mailcli 1.0.4" ]]
