...
3. An idle `drafts send --ref REF --confirm --json` builds RFC 5322/MIME, submits over SMTP with STARTTLS, and mirrors to Sent over IMAP. Transfer budgets are size-aware and capped at 15 minutes.
